...
// source: /Users/huxin/DockerVolumes/Nginx/www/over-blog/back-end/Go/iris/views/category.html
// DO NOT EDIT!
package template
	...
	if tag != "" {
		buffer.WriteString(`
                <div class="row b-tag-title">
                    <div class="col-xs-12 col-md-12 col-lg-12">
                        <h3>拥有<span class="b-highlight">`)
		hero.EscapeHTML(tag, buffer)
		buffer.WriteString(`</span>标签的文章</h3>
                    </div>
                </div>
                `)
	}
		...
		if search != "" {
			buffer.WriteString(`
                                    <p style="text-align: center;font-size: large">
                                        博主很懒,暂时没有写关于"`)
			buffer.WriteString(search)
			buffer.WriteString(`"的文章,看看其它文章吧！</p>
                                    `)
		} else {
			buffer.WriteString(`
                                    <p style="text-align: center;font-size: large">
