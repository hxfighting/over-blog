...
获取需要的数据
*/
func getRequestData(ctx iris.Context, fields ...string) (map[string]interface{}, error) {
...
验证数据，获取模型
*/
func getRightModel(ctx iris.Context, model interface{}, fields, validateField []string) error {
	requestData, err := getRequestData(ctx, fields...)
	if err != nil {
		return err
	}
