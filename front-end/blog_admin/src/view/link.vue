<template>
  <div>
    <card>
      ...
      <Modal v-model="modal_add" scrollable :mask-closable="false" :closable="false" title="新增友联"
             @on-ok="addLink('formCustom')"
      ...
      <Modal v-model="modal_update" scrollable :mask-closable="false" :closable="false" title="编辑友联"
             @on-ok="updateLink('formCustomTwo')"
